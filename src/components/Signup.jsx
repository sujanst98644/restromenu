...
const Signup = () => {
  return (
    <main className="flex flex-col justify-center items-center bg-[#EEF7FF] h-screen">
      <Link className="self-start m-5 text-3xl text-green-700 font-light" to="/restromenu">
        <FaChevronLeft />
      </Link>
      <div className="flex flex-row h-5/6 justify-center space-x-10 m-24 items-center">
        <div className="flex flex-col w-80 space-y-2 items-center">
          <div className="border-2 p-7 w-80 shadow-xl rounded-md">
            <form className="space-y-2 flex flex-col items-center">
              ...
              <input
                type="text"
                className=" bg-gray-200 rounded p-2 text-xs w-4/5 shadow-xl"
          ...
          <div className="w-80 border-2 p-7 shadow-xl rounded-md">
            <p>
